...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/WebWork/OpenServer/domains/steam/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/WebWork/OpenServer/domains/steam/app/cache/prod/assetic/config'), false)));
    ...
    {
        require_once 'C:/WebWork/OpenServer/domains/steam/app/cache/prod/jms_diextra/doctrine/EntityManager_510e388bad9af.php';
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_1a2a3eb7538d325f56e029fedb347133');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_1a2a3eb7538d325f56e029fedb347133');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_1a2a3eb7538d325f56e029fedb347133');
        ...
        $d->setProxyDir('C:/WebWork/OpenServer/domains/steam/app/cache/prod/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager510e388bad9af_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($e, $this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('C:/WebWork/OpenServer/domains/steam/app/cache/prod/jms_diextra/metadata'));
        return $instance;
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('C:/WebWork/OpenServer/domains/steam/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('C:/WebWork/OpenServer/domains/steam/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/WebWork/OpenServer/domains/steam/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => 'C:/WebWork/OpenServer/domains/steam/app/cache/prod/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $a = $this->get('security.context');
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => 'C:/WebWork/OpenServer/domains/steam/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/WebWork/OpenServer/domains/steam/app/../web', false);
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('C:/WebWork/OpenServer/domains/steam/app/cache/prod/jms_security/expressions');
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('C:/WebWork/OpenServer/domains/steam/app/cache/prod/jms_security', false));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/WebWork/OpenServer/domains/steam/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/WebWork/OpenServer/domains/steam/app/cache/prod',
            ...
            'session.save_path' => 'C:/WebWork/OpenServer/domains/steam/app/cache/prod/sessions',
            ...
            'router.resource' => 'C:/WebWork/OpenServer/domains/steam/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/WebWork/OpenServer/domains/steam/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.memory.path' => 'C:/WebWork/OpenServer/domains/steam/app/cache/prod/swiftmailer/spool',
            ...
            'assetic.cache_dir' => 'C:/WebWork/OpenServer/domains/steam/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'C:/WebWork/OpenServer/domains/steam/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => 'C:/WebWork/OpenServer/domains/steam/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => 'C:/WebWork/OpenServer/domains/steam/app/cache/prod/jms_diextra',
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'C:/WebWork/OpenServer/domains/steam/app/cache/prod/jms_diextra/doctrine/EntityManager_510e388bad9af.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager510e388bad9af_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => 'C:/WebWork/OpenServer/domains/steam/app/cache/prod/jms_security',
